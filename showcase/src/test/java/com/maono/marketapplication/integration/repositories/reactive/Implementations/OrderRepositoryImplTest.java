...
import com.maono.marketapplication.repositories.reactive.implemantations.OrderRepositoryImpl;
...
@DataR2dbcTest
@Import({IntegrationTestPostgresConfiguration.class, OrderRepositoryImpl.class})
