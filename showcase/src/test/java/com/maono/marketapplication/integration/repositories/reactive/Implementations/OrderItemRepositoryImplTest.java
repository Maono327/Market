package com.maono.marketapplication.integration.repositories.reactive.Implementations;
...
import com.maono.marketapplication.repositories.reactive.implemantations.OrderItemRepositoryImpl;
...
@DataR2dbcTest
@Import({IntegrationTestPostgresConfiguration.class, OrderItemRepositoryImpl.class})
